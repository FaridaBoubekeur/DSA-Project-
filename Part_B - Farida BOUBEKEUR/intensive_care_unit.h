...
public:
    ...
    void insertHistory_remove(const Patient &, const int &); // insert the patient in the history of the unit (in the hospital)
    void insertHistory_insertion(const Patient &);           // insert the patient in the history of the unit (in the hospital)
...
private:
    BSTree patients_list;   // the patients are added in a hash table
